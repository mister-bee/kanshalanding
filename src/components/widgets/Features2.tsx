...
const Features2 = ({ header, items }: FeaturesProps) => (
  <>
    <h1 style={{ fontSize: "2em", textAlign: "center" }}>email: admin@beechtree.ai</h1>
    ...
    <section className="relative py-16 lg:py-20" id="features2">
      ...
      <div className="relative mx-auto -mb-12 max-w-6xl px-4 sm:px-6">
        ...
        <div
          className={`my-12 ${items.length > 2 ? 'grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3' : 'flex justify-center'
            } items-stretch gap-6`}
        >
